...
_M.MOVEBEHAVIOR_SPEED_FIELD = protobuf.FieldDescriptor();
_M.MOVEBEHAVIOR_TARGETPOS_FIELD = protobuf.FieldDescriptor();
...
_M.MOVEDATA_MOVEBEHAVIOR_FIELD = protobuf.FieldDescriptor();
...
_M.C2SSCENEPROTOCOL.values = {_M.C2SSCENEPROTOCOL_REQMOVE_ENUM}
...
_M.ENTITYPOS_POSX_FIELD.type = 5
_M.ENTITYPOS_POSX_FIELD.cpp_type = 1
...
_M.ENTITYPOS_POSY_FIELD.type = 5
_M.ENTITYPOS_POSY_FIELD.cpp_type = 1
...
_M.ENTITYPOS_POSZ_FIELD.type = 5
_M.ENTITYPOS_POSZ_FIELD.cpp_type = 1
...
_M.MOVEBEHAVIOR_SPEED_FIELD.name = "speed"
_M.MOVEBEHAVIOR_SPEED_FIELD.full_name = ".SceneProtocol.MoveBehavior.speed"
_M.MOVEBEHAVIOR_SPEED_FIELD.number = 2
_M.MOVEBEHAVIOR_SPEED_FIELD.index = 1
_M.MOVEBEHAVIOR_SPEED_FIELD.label = 1
_M.MOVEBEHAVIOR_SPEED_FIELD.has_default_value = false
_M.MOVEBEHAVIOR_SPEED_FIELD.default_value = 0
_M.MOVEBEHAVIOR_SPEED_FIELD.type = 13
_M.MOVEBEHAVIOR_SPEED_FIELD.cpp_type = 3

_M.MOVEBEHAVIOR_TARGETPOS_FIELD.name = "targetPos"
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.full_name = ".SceneProtocol.MoveBehavior.targetPos"
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.number = 3
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.index = 2
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.label = 1
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.has_default_value = false
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.default_value = nil
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.message_type = _M.ENTITYPOS
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.type = 11
_M.MOVEBEHAVIOR_TARGETPOS_FIELD.cpp_type = 10
...
_M.MOVEBEHAVIOR.fields = {_M.MOVEBEHAVIOR_STATE_FIELD, _M.MOVEBEHAVIOR_SPEED_FIELD, _M.MOVEBEHAVIOR_TARGETPOS_FIELD}
...
_M.MOVEDATA_CURPOS_FIELD.message_type = _M.ENTITYPOS
_M.MOVEDATA_CURPOS_FIELD.type = 11
_M.MOVEDATA_CURPOS_FIELD.cpp_type = 10

_M.MOVEDATA_MOVEBEHAVIOR_FIELD.name = "moveBehavior"
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.full_name = ".SceneProtocol.MoveData.moveBehavior"
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.number = 3
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.index = 2
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.label = 2
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.has_default_value = false
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.default_value = nil
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.message_type = _M.MOVEBEHAVIOR
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.type = 11
_M.MOVEDATA_MOVEBEHAVIOR_FIELD.cpp_type = 10

_M.MOVEDATA.name = "MoveData"
_M.MOVEDATA.full_name = ".SceneProtocol.MoveData"
_M.MOVEDATA.nested_types = {}
_M.MOVEDATA.enum_types = {}
_M.MOVEDATA.fields = {_M.MOVEDATA_ACTORID_FIELD, _M.MOVEDATA_CURPOS_FIELD, _M.MOVEDATA_MOVEBEHAVIOR_FIELD}
